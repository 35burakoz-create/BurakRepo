...
function run(){const checks=[];const add=(name,ok,detail='')=>checks.push({name,ok:!!ok,detail:String(detail||'')});
 ...
 add('Pristine core bridge',typeof R.coreSwitch==='function'&&R.__coreBridge===true,'core primitives captured');
 ...
 add('Legacy V38 shell yok',!document.querySelector('script[src="v38-ux-shell.js"],script[src="./v38-ux-shell.js"]'),'legacy shell disabled');
 add('Legacy V41 propagation yok',!document.querySelector('script[src="v41-propagation-assistant.js"],script[src="./v41-propagation-assistant.js"]'),'legacy propagation disabled');
 add('Legacy V42 polish yok',!document.querySelector('script[src="v42-ui-polish.js"],script[src="./v42-ui-polish.js"]'),'legacy polish disabled');
 ...
 add('Propagation görünümü',!!document.querySelector('#tab-propagation'),'#tab-propagation');

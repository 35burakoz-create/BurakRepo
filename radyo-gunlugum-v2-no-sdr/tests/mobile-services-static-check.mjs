...
check('menu delegates install',menu.includes("if(a==='install')")&&menu.includes('return R.installPWA?.()')&&menu.includes('R.pwaInstall?.isStandalone?.()')&&!menu.includes('R.installPrompt.prompt'));

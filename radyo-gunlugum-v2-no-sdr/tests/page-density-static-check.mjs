...
const cacheMatch=config.match(/cacheVersion:'v385-core-boundary-[^']*-(\d{8})-(\d+)'/);
check('fresh page density PWA generation',!!cacheMatch&&Number(cacheMatch[1])>=20260910&&Number(cacheMatch[2])>=9);

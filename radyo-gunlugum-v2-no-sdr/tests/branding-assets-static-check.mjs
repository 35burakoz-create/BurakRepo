...
for(const asset of ['./app-branding-assets.js','./app-branding-assets.css','./apple-touch-icon.png','./icon.svg'])assert(sw.includes(`'${asset}'`),`service worker must cache ${asset}`);

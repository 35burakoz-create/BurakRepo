...
check('service worker carries latest UI-polish release signature so existing PWA installs refresh cached modules',sw.includes("RADIO_INTELLIGENCE_POLISH='20260916-3'"));

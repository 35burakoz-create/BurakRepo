...
check('foundation dialogs are lifted above the dock',audit.includes('.foundation-diag-overlay,.app-listen-modal-bg,.app-radio-glossary-bg,.app-collection-overlay')&&audit.includes('.foundation-diag,.app-listen-modal,.app-radio-glossary-modal,.app-collection'));
...
check('geometry fix has a fresh PWA generation',!!cache&&Number(cache[1])>=15);

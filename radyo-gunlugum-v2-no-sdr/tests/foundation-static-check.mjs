...
const index=read('index.html'),boot=read('app-bootstrap.js'),sw=read('sw.js'),config=read('app-config.js'),follow=read('v37-integrity-followup.js'),search=read('v44-search-rebuild.js'),memory=read('app-memory.js');
...
check('config is V3.7.2',config.includes("version:'3.7.2'")&&config.includes("displayVersion:'V3.7.2'"));

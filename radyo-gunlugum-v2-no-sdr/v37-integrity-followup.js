...
// Load the V3.3 Focus UX only after the current-program and integrity layers are ready.
...
(async()=>{for(let i=0;i<100;i++){if(typeof R.radioNowCandidates==='function'&&Object.prototype.hasOwnProperty.call(R,'v36Settings'))break;await new Promise(r=>setTimeout(r,50))}try{await loadOnce('v38-listening-mode.js');await loadOnce('v38-ux-shell.js')}catch(e){console.error('V3.3 Focus UX yüklenemedi',e)}})();
})();

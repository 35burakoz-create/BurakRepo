...
const MODULES=[
 'v24-achievements.js','v25-smart-listening.js','v26-radio-atlas.js','v30-ai-radio-assistant.js','v38-listening-mode.js',
 'app-foundation.js','app-runtime-core.js','app-router-core.js','app-current-programs.js','app-record-integrity.js','app-smart-analyzer.js','app-user-services.js',
 'app-shell.js','app-propagation.js','app-memory.js','v44-search-rebuild.js','app-audio-safety.js','app-backup.js','app-ui-state.js','app-smoke.js'
];
